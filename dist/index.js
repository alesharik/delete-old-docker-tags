...
class DockerRegistryClient {
    ...
    getManifestDigest(repository, tag) {
        return __awaiter(this, void 0, void 0, function* () {
            return (yield (0, axios_1.default)({
                method: 'GET',
...
function deleteTag(client, repository, tag) {
    return __awaiter(this, void 0, void 0, function* () {
        core.info(`Deleting ${tag} tag`);
        try {
            const manifest = yield client.getManifestDigest(repository, tag);
            yield client.deleteManifest(repository, manifest);
...
class Tag {
    constructor(original, semver) {
        this.original = original;
        this.semver = semver;
    }
    static parse(value, extractor = /v?(\d+(.\d+)*)/) {
        ...
        while (true) {
            const semver = (0, semver_1.parse)(ver);
            if (!semver) {
    ...
    rcompare(other) {
        return (0, semver_1.rcompare)(this.semver, other.semver);
    }
}
exports["default"] = Tag;
